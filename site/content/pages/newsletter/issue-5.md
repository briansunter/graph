...
I'm sharing my logseq [comparison-template]({{< sref "/pages/comparison-template" >}}). This simple framework will help you make the best decision between different options.
...
I created a [comparison template]({{< sref "/pages/comparison-template" >}}) in Logseq for this purpose.

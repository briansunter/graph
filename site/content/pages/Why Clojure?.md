...
This code in Clojure behaves the way I want, comparing equality of values, and I don't need to know the difference between `=`, `equals`, `{{< logseq/mark >}}`, `{{< / logseq/mark >}}=`, `deepEqual`, and `deepStrictEqual`.

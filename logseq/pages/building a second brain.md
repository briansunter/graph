...
- # Impressions
	...
	- I'm a big fan of tool-agnostic workflows and philosophical frameworks for productivity. There's a tendency for people to be tool-obsessed, but I think it's better to be able to describe your workflow in plain english, then select a tool that supports it best.
	- For a book about summarization, it's a bit wordy. There are a lot of anecdotes and tangents. These might be useful to those starting out, but as someone following Forte for several years I found them a bit verbose.
- # Who Should Read It?
	...
	- Someone looking for a good notetaking workflow framework
- # How the Book Changed Me
	...
	- I loosely follow the progressive summarization idea, but I don't usually do the second pass highlighting. It's hard to be selective in what you capture, while still having enough information to do two passes of highlighting. I may start capturing slightly more context, for example whole paragraphs instead of individual sentences to do this better.
	- The project checklist and weekly review are good ideas that I'll definitely incorporate into my notetaking system.
- # My Top 3 Quotes
...
- # Summary + Notes
	- # CODE
	  collapsed:: true
		...
		- # Capture
			- The second brain process starts by capturing information that resonates with you, either from external sources or your internal moments of insight.
			- Capturing information frees you from the burden of trying to remember everything.
			...
			- ### How to decide what to capture
			  collapsed:: true
				- You want to avoid capturing too much information or too little, so Forte offers some insights on how to decide what to capture.
				...
				- The main advice to to capture things that resonate with you
				- Ask yourself:
				  collapsed:: true
					- Does it inspire me?
					- Is it useful?
				...
				- ### Favorite questions
				  collapsed:: true
					- Another technique that's helpful in deciding what to capture is having a list of "favorite questions", and capturing anything that relates to these questions.
		...
		- # Organize
			...
			- You might be tempted to organize things by "subjects", but this is suboptimal. For example, you might consider putting an article in a "psychology" folder. But under what circumstance are you going to scroll through all of your articles related to the broad subject of "psychology"?
			- Organizing your information around focused projects and broad areas of your life is better.
			- Forte proposes a system for organization called **PARA** , which stands for Project, Area, Resource, and Archive.
			- ## PARA
				- ### Projects
				  collapsed:: true
					- Short-term efforts in your work or life that you’re working on now.
					- These have a beginning and end
					- They also have a clear outcome needed for the project to be considered "done".
				...
				- ### Areas
				  collapsed:: true
					...
					- Usually projects live under an area.
					- |Project|Area|
					  |--|--|
				  ...
				  collapsed:: true
					...
					- For example:
					  collapsed:: true
						...
						- Areas of responsibility that are no long relevent
						- Resources that are no longer relevent, for example hobbies you've discontinued
			- ### How to decide where to put notes
				- The moment you decide to capture something isn't the best time to organize it.
				- You haven't had time to consider the note, also it increases the friction in capturing notes
			...
			-
		- # Distill
			- It's important to distill notes to their most imporant points so they are useful in the future. It helps you quickly refresh your memory on a note without having to reread it.
			...
			- ## Progressive Summarization
			  collapsed:: true
				...
				- ### Layer one - Captured notes
				  collapsed:: true
					- Layer one are the key excerpts of the snippets you've captured
					- Don't try to capture the entire article.
					- These captured excerpts still aren't concise enough
				- ### Layer two - Bolding the most important parts
				  collapsed:: true
					...
					- These subsequent steps should be done when you have time for focused work, not at the time of capture
					- These bolded passes are much faster to look back on than reading the entire article. It might only take a minute to refresh your memory, instead of several minutes reading your excerpts
				- ### Layer three- Highlighting the bolded passages
				  collapsed:: true
					- Layer three is highlighting the only the most important points of the bolded passages from Layer two.
					- This is an optional step, for especially long, interesting, or valuable notes.
					- This is often just a few sentences or half sentences.
				- ### Layer four - Executive Summary
				  collapsed:: true
					...
					- This is usually only done for your most valuable notes, the ones where you come back to often
			- ### Common Mistakes
			- #### Highlighting too much
				...
				- #### Highlighting without a purpose in mind
					...
					- It takes time to distill your notes, so wait until you have a clear purpose, otherwise you're making a large time investment without knowing if it wil pay off.
					- One rule of thumb is you should make the note a little more discoverable every time you "touch" it, by summarizing or adding a commentary
		...
		- # Express
			...
			- ### How to resurface your past work
				- #### Search
					- Digital notetaking systems have a huge advantage over physical systems: you can search their full contents in less than a second.
					- This should be the first retrieval method you turn to and it's most useful when you already know what you're looking for.
				- #### Browsing
					- If you've been following the second brain system, you already have your notes categories by projects and areas
					- This is slower than search, but lets you gradually hone in on the information you're looking for
					- It's useful to take advantage of sorting, such as by date created
				- #### Tags
					- Tags allow you to apply labels to notes regardless of where they're located
					...
					- The downside of tags is they require a lot of energy compared to search and folders
				- #### Serendipity
					- Sometimes a connection will just jump out at you
					- We can't plan for this, but we can create conditions where it is more likely to happen
					- One tip is when using the previous retrieval methods, keep your focus broad. Don't just search in a specific folder, look through related folders too.
					- You may want to look through five or six of your PARA folders, which you've ideally already summarized so it won't take too much time
					...
					- Other people can give you valuable feedback such as pointing out aspects of your ideas or sources you hadn't considered, or contribute their own ideas.
	- # Essential notetaking habits
		...
		- # Project Checklists
			- Ensure you start and finish your projects in a consistent way, making use of past work.
			- The two most important moments in projects are when you start them and when you finish them.
			- Since these moments are so important, you should have a defined process for them
			- ## Project kickoff checklist
			  collapsed:: true
				- ### 1. Capture your current thinking on the project
					- Create a dedicated note for the project and start brainstorming
					- This is a messy step where you should think about potentially approaches, how it relates to other topics, people you should talk to about it, etc.
				...
				- ### 3. Search for related terms across all folders
					- Search through your own notes, which are more focused an higher quality than stuff on the internet
				- ### 4. Tag relevent notes to the project
					- Use the features from your notetaking app to tag, link, or move relevant notes to the project.
				- ### 5. Create an outline of collected notes and plan the project
					- Create an outline that makes it clear what you should do next
					- This should be a plan for how to tackle the project, not doing executing the project itself.
					- The first pass should only take 20-30 minutes.
					- For an essay, this might be the main points or headings of the final piece
					- If it's a collaborate project, you might want to outline the objectives and areas of responsibility for each person
			...
			- ## Project completion checklist
				- The completion of a project is special because it a rare moment when something actually ends.
				...
				- ### 2. Cross out the associated project goal and move to “Completed” section.
					- Review the projects goal and reflect how it panned out
				...
				- ### 3. Review and organize parts that could be reused
					...
					- For example, a web page design could be used as a template for future sites, or an agenda for a one on one performance review, or interview questions you used for hiring
				...
				- ### 5. If canceled or paused, record current status
					- If you cancel or postpone a project, archive it, but mark the current status with some comments
					- For example, describe the last action you took and why you postponed it
